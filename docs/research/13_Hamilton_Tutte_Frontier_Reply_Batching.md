...
M4.3b3b2b2b1 已按相同 span 映射批量写出规范 child edge SoA，M4.3b3b2b2b2a 又完成规则 [frontier leaf batching](16_Hamilton_Tutte_Frontier_Leaf_Batching.md)；两阶段都继续保持 `N=1`/批量 proof 逐字节一致。
